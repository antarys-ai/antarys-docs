...
description: Turn any Data into Intelligent Data. AI embeddings and Large Language Models depend on your vector data and we are transforming the paradigm of AI data industry
---
...
<Cards>
  <Card title="For Apple ARM" href="https://github.com/antarys-ai/antarys-releases/releases/download/preview/antarys-apple-arm.zip">
    Download for Apple M chips only, intel builds coming soon
  </Card>
  <Card title="For Linux x64" href="https://github.com/antarys-ai/antarys-releases/releases/download/preview/antarys-linux-x64.zip">
    Universal binary for linux for x64 architecture, x86 and ARM coming soon
  </Card>
  <Card title="For Windows x64">
...
<Card title="See Extended Benchmarks" href="https://www.antarys.ai/benchmark">
...
### For Qdrant
![Qdrant Image Search](/image_q/qdrant_image_search.png)

### For Milvus
![Milvus Image Search](/image_q/milvus_image_search.png)

### For Antarys
![Antarys Image Search](/image_q/antarys_image_search.png)
